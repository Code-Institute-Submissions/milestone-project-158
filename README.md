...
### Timeline
In the future I would like to add a cool horizontal timeline with little icons along it showing how Billy got started in music and what some of his early experiences were. This would replace the current write up at the top of the gallery section and would be interactive.
...
Fontawesome version 5.15.1 was used to add icons to various aspects of the website such as the footer and the contact page. These icons can be very powerful in conveying a very clear message in a concise way.
...
I firstly went to my Github repository and went to the settings section. I scrolled down on the options tab until I reached the GitHub pages heading. I switched the source from none to master branch. Then I clicked save and this uploaded my work to GitHub Pages. 
...
* Check that when the page is resized for different mobile devices that all of the content is still viewable. 
...
### Music
* Check that the videos don't autoplay on loading the page. 
* Make sure that all links to other artists open in a new tab

### Contact
* Ensure contact heading and form are visible against background image
* Use form incorrectly in different ways to make sure the 'required' attribute is working properly 
...
* When I linked to version 4.5.3 of Bootstrap after this issue, the formatting for my navigation bar stopped functioning the way I wanted it to.
...
* *fix* - I found a very helpful answer on stack overflow here [https://stackoverflow.com/questions/8097744/how-do-i-center-this-form-in-css/8097900]. The answer explained very clearly how to ensure that the parent div would be centered in the middle of the screenbut the form would be aligned to the left.
...
* Contact form alignment - I read a very useful anwswer on how to get a form to be in the center of the screen but be aligned to the left of its container div. The answer was given here [https://stackoverflow.com/questions/8097744/how-do-i-center-this-form-in-css/8097900].
